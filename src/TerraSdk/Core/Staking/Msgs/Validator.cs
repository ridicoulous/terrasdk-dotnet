...
namespace TerraSdk.Core.Staking.Msgs
{
    ...
    ///     coins. SlashingApiService results in a decrease in the exchange rate, allowing correct
    ...
    public class Validator
    {
        ...
        public Validator(string operatorAddress, string consPubKey, bool jailed, BondStatus status, BigInteger tokens, BigDecimal delegatorShares,
            ValidatorDescription description, long unbondingHeight, DateTimeOffset unbondingCompletionTime, ValidatorCommission commission,
            BigInteger minSelfDelegation)
        {
