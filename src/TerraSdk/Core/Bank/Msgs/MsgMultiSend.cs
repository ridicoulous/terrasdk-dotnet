...
namespace TerraSdk.Core.Bank.Msgs
{
    ...
    {
        private static readonly string InternalType = "bank/MsgMultiSend";
        ...
        public MsgMultiSend(Io[] inputs, Io[] outputs)
        {
            Type = InternalType;
            Value = new MsgValue
            {
        ...
        public static MsgMultiSend FromData(MsgData msgData)
        {
            return InternalFromData<MsgMultiSend, MsgValue>(msgData, InternalType);
        }
        ...
        public class Io
        {
            ...
            public Io(AccAddress accAddress, Coins coins)
            {
                AccAddress = accAddress;
                Coins = coins;
            }

            public Io(AccAddress accAddress, params Coin[] coins)
            {
                AccAddress = accAddress;
