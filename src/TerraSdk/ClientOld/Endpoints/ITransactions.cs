...
namespace TerraSdk.ClientOld.Endpoints
{
    ...
    public interface ITransactions
    {
        ...
        /// Transaction events such as ‘send’. Note that each module documents its own events. look for xx_events.md in the corresponding Terra-sdk/docs/spec directory.
        /// </param>
