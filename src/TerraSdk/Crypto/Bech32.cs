...
namespace TerraSdk.Crypto
{
	public static class Bech32
	{
        ...
        private static readonly string ALPHABET = "qpzry9x8gf2tvdw0s3jn54khce6mua7l";
        private static readonly byte[] ALPHABET_MAP = Encoding.ASCII.GetBytes(ALPHABET);
  ...
  //      private static readonly string Charset = "qpzry9x8gf2tvdw0s3jn54khce6mua7l";
		...
		//	return ret;
		//}
        public static string Encode(string prefix, object toWords)
        {
        ...
        public static (string prefix, byte[] words) DecodeUnsafe(string address)
        {
            throw new NotImplementedException();
        }

        public static byte[] FromWordsUnsafe(object words)
        {
            throw new NotImplementedException();
        }
    }
