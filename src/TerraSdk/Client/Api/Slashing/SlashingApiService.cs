...
{
    internal class SlashingApiService : ISlashingApiService
    {
        private readonly Func<IFlurlClient> _clientGetter;

        public SlashingApiService(Func<IFlurlClient> clientGetter)
        {
        ...
        public Task<ResponseWithHeight<IList<ValidatorSigningInfo>>> GetSigningInfosAsync(int? page = default, int? limit = default,
        ...
        public Task<GasEstimateResponse> PostUnjailSimulationAsync(string validatorAddress, UnjailRequest request,
            CancellationToken cancellationToken = default)
        {
