...
namespace TerraSdk.Client.Api.Tx
{
    ...
    public class TxResponse
    {
        ...
        public TxResponse(long height, string txHash, uint code, string data, string rawLog, IList<ABCIMessageLog> logs, string info, long gasWanted,
            long gasUsed, string codespace, ITx tx, DateTimeOffset timestamp)
        {
            Height = height;
            TxHash = txHash;
            Code = code;
        ...
        [JsonProperty(PropertyName = "data")] public string Data { get; set; } = null!;

        [JsonProperty(PropertyName = "raw_log")]
        public string RawLog { get; set; } = null!;

        [JsonProperty(PropertyName = "logs")] public IList<ABCIMessageLog> Logs { get; set; } = null!;

        [JsonProperty(PropertyName = "info")] public string Info { get; set; } = null!;
