...
namespace TerraSdk.Client.Api.Tx
{
    public class BroadcastTxResult
    {
        ...
        public BroadcastTxResult(string txHash, int? height, string? rawLog, IList<ABCIMessageLog> logs, ulong gasWanted, ulong gasUsed,
            IList<StringEvent> events)
        {
            TxHash = txHash;
            Height = height;
            RawLog = rawLog;
        ...
        [JsonProperty("logs")] public IList<ABCIMessageLog> Logs { get; set; } = null!;
