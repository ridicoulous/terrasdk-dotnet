...
{
    internal class GovernanceApiService : IGovernanceApiService
    {
        private readonly Func<IFlurlClient> _clientGetter;

        public GovernanceApiService(Func<IFlurlClient> clientGetter)
        {
            _clientGetter = clientGetter;
        }

        public Task<ResponseWithHeight<IList<Proposal>>> GetProposalsAsync(string? voter = default, string? depositor = default,
            ProposalStatus? status = default,
        ...
        public ResponseWithHeight<IList<Proposal>> GetProposals(string? voter = default, string? depositor = default,
            ProposalStatus? status = default,
            ulong? limit = default)
        {
        ...
        public Task<GasEstimateResponse> PostProposalSimulationAsync(PostProposalReq request, CancellationToken cancellationToken = default)
        {
            ...
            request = new PostProposalReq(baseReq, request.Title, request.Description, request.ProposalType, request.Proposer,
        ...
        {
            var request = new PostProposalReq(baseReq, title, description, ProposalContentTypeFromType(proposalContentType), proposer,
                initialDeposit);
        ...
        public GasEstimateResponse PostProposalSimulation(BaseReq baseReq, string title, string description, string proposer,
            IList<Coin> initialDeposit,
        ...
        public Task<GasEstimateResponse> PostDepositSimulationAsync(ulong proposalId, DepositReq request,
