...
{
    /// <summary>
    ///     GovernanceApiService module APIs.
    /// </summary>
    public interface IGovernanceApiService
    {
        /// <summary>
        ///     Query proposals.
        /// </summary>
        ...
        /// <returns></returns>
        Task<ResponseWithHeight<IList<Proposal>>> GetProposalsAsync(string? voter = default, string? depositor = default,
            ProposalStatus? status = default, ulong? limit = default, CancellationToken cancellationToken = default);
        ...
        /// <param name="limit">Maximum number of items.</param>
        /// <returns></returns>
        ResponseWithHeight<IList<Proposal>> GetProposals(string? voter = default, string? depositor = default, ProposalStatus? status = default,
            ulong? limit = default);
        ...
        /// </summary>
        /// <returns></returns>
        Task<GasEstimateResponse> PostProposalSimulationAsync(BaseReq baseReq, string title, string description, string proposer,
        ...
        /// </summary>
        /// <returns></returns>
        Task<GasEstimateResponse> PostProposalSimulationAsync<TContentType>(BaseReq baseReq, string title, string description, string proposer,
        ...
        /// </summary>
        /// <returns></returns>
        GasEstimateResponse PostProposalSimulation(BaseReq baseReq, string title, string description, string proposer, IList<Coin> initialDeposit,
        ...
        /// </summary>
        /// <returns></returns>
        GasEstimateResponse PostProposalSimulation<TContentType>(BaseReq baseReq, string title, string description, string proposer,
        ...
        /// </summary>
        /// <returns></returns>
        Task<StdTx> PostProposalAsync(BaseReq baseReq, string title, string description, string proposer, IList<Coin> initialDeposit,
        ...
        /// </summary>
        /// <returns></returns>
        Task<StdTx> PostProposalAsync<TContentType>(BaseReq baseReq, string title, string description, string proposer, IList<Coin> initialDeposit,
            CancellationToken cancellationToken = default) where TContentType : IProposalContent;
        ...
        /// </summary>
        /// <returns></returns>
        StdTx PostProposal<TContentType>(BaseReq baseReq, string title, string description, string proposer, IList<Coin> initialDeposit)
            where TContentType : IProposalContent;
        ...
        /// <summary>
        ///     Gets a proposal’s tally result at the current time. If the proposal is pending deposits (i.e status
        ///     ‘DepositPeriod’) it returns an empty tally result.
        /// </summary>
        /// <param name="proposalId"></param>
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
