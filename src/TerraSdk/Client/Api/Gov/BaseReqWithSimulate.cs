...
namespace TerraSdk.Client.Api.Gov
{
    public class BaseReqWithSimulate : BaseReq
    {
        ...
        public BaseReqWithSimulate(string from, string? memo, string chainId, ulong accountNumber, ulong sequence, IList<Coin>? fees,
            IList<Coin>? gasPrices, string? gas, string? gasAdjustment, bool simulate) : base(from, memo, chainId, accountNumber, sequence, fees,
        ...
        [JsonProperty("simulate")] public bool Simulate { get; set; }
    }
}