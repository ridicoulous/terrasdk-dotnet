...
namespace TerraSdk.Client.Api.Mint
{
    ...
    public class MintParams
    {
        ...
        public MintParams(string mintDenom, BigDecimal inflationRateChange, BigDecimal inflationMax, BigDecimal inflationMin, BigDecimal goalBonded,
            ulong blocksPerYear)
        {
            MintDenom = mintDenom;
