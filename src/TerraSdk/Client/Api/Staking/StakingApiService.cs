...
{
    internal class StakingApiService : IStakingApiService
    {
        private readonly Func<IFlurlClient> _clientGetter;

        public StakingApiService(Func<IFlurlClient> clientGetter)
        {
        ...
        public Task<ResponseWithHeight<IList<UnbondingDelegation>>> GetUnbondingDelegationsAsync(string delegatorAddr,
            CancellationToken cancellationToken = default)
        {
            return _clientGetter()
        ...
        public Task<ResponseWithHeight<IList<Redelegation>>> GetRedelegationsAsync(string? delegator = default, string? validatorFrom = default,
        ...
        {
            var baseReq = new BaseReqWithSimulate(request.BaseReq, true);
            request = new RedelegateRequest(baseReq, request.DelegatorAddress, request.ValidatorSrcAddress, request.ValidatorDstAddress,
                request.Amount);
        ...
        public Task<ResponseWithHeight<Validator>> GetValidatorAsync(string delegatorAddr, string validatorAddr,
            CancellationToken cancellationToken = default)
        {
            return _clientGetter()
        ...
        public Task<IList<PaginatedTxs>> GetTransactionsAsync(string delegatorAddr, IList<DelegatingTxType>? txTypes = default,
            CancellationToken cancellationToken = default)
        {
            if (txTypes == null || txTypes.Count <= 0) txTypes = (DelegatingTxType[]) Enum.GetValues(typeof(DelegatingTxType));
...
//.SetQueryParam("type", string.Join<>('+', txTypes.Select(type => type.EnumMember())), true)
        ...
        public Task<ResponseWithHeight<IList<Delegation>>> GetDelegationsByValidatorAsync(string validatorAddr,
            CancellationToken cancellationToken = default)
        {
            return _clientGetter()
        ...
        public Task<ResponseWithHeight<IList<UnbondingDelegation>>> GetUnbondingDelegationsByValidatorAsync(string validatorAddr,
            CancellationToken cancellationToken = default)
        {
            return _clientGetter()
