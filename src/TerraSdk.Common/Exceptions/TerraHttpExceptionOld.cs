...
{
    public class TerraHttpExceptionOld : Exception
    {
        ...
        internal TerraHttpExceptionOld(FlurlHttpException innerException) : base(innerException.Message, innerException)
        {
