...
using System.Text;
using TerraSdk.Crypto.Ecdsa.Internal.Sha256;

namespace TerraSdk.Crypto.Ecdsa.Internal.Secp256K1
{
    internal class EcMultGen
    {
        ...
        public static void Blind(EcmultGenContext ctx, byte[] seed32)
        {
            ...
            Sha256.Hash.Rfc6979HmacSha256Initialize(rng, keydata, (UInt32)(seed32 != null ? 64 : 32));
            Util.MemSet(keydata, 0, keydata.Length); //memset(keydata, 0, sizeof(keydata));
            /* Retry for out of range results to achieve uniformity. */
            do
            {
                Sha256.Hash.Rfc6979HmacSha256Generate(rng, nonce32, 32);
            ...
            Sha256.Hash.Rfc6979HmacSha256Finalize(rng);
