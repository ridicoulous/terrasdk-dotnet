...
namespace TerraSdk.Test.Crypto.Bip32
{
    ...
    public class VectorTests
    {
        ...
        {
            TerraSdk.Crypto.Bip32.Bip32 bip32 = new TerraSdk.Crypto.Bip32.Bip32();

            var masterKeyFromSeed = bip32.GetMasterKeyFromSeed(seed.HexToByteArray());
        ...
        private (byte[] Key, byte[] ChainCode) TestDerivePath(string path, string seed)
        {
            ...
            var derivePath = bip32.DerivePath(path, seed.HexToByteArray());
