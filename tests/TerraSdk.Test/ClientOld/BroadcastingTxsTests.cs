...
namespace TerraSdk.Test.Client
{
    public class ClientTests : BaseTestClient
    {
        ...
        public async Task AsyncCreateTransactionTransferCoins()
        {
            ...
            var result = await ((ITerraApiClient)client).SendAsync( Configuration.LocalAccount1Address, Configuration.LocalAccount2Address, coinsToSend, BroadcastTxMode.Block, fee, Configuration.LocalAccount1PrivateKey, Configuration.LocalAccount1Passphrase, memo);
